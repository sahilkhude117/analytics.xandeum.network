...
export type GetStatsResponse = RPCResponse<GetStatsResult>;
...
export type GetPodsWithStatsResponse = RPCResponse<GetPodsWithStatsResult>;
...
export type GetPodsResponse = RPCResponse<GetPodsResult>;
...
export interface PNodeStatsSnapshot {
  pubkey: string;
  timestamp: Date;
